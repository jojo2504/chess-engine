...
pub struct State {
    ...
    pub(crate) can_white_king_castle: bool,
    pub(crate) can_white_queen_castle: bool,
    pub(crate) can_black_king_castle: bool,
    pub(crate) can_black_queen_castle: bool,
    pub(crate) en_passant_square: Option<Square>, // null if none
    ...
    pub(crate) captured_piece: Option<Piece>,  // null if none
...
impl Default for State {
    fn default() -> Self {
        Self { 
            ...
            full_move_number: 0, 
            half_move_clock: 0, 
            can_white_king_castle: false,
            can_white_queen_castle: false,
            can_black_king_castle: false,
            can_black_queen_castle: false,
